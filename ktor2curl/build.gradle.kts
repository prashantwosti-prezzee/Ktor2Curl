...
kotlin {
    ...
    // JVM target so non-Android consumers (the :sample console app, server-side Ktor) can use the
    // plugin directly, and so commonTest also runs on the fast `jvmTest` task.
    jvm()
